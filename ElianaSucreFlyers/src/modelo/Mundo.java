...
public class Mundo {
	...
	public Mundo() {
		...
		heli = new Helicopter();
		superwoman = new Superwoman();
		
	}

	public Superwoman getSuperwoman() {
		return superwoman;
	}

	public void setSuperwoman(Superwoman superwoman) {
		this.superwoman = superwoman;
	}
